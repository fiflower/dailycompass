...
const AuthPage = ({ onLogin }) => {
    ...
    const handleSignup = async (e) => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch('/https://eldailycompass-apim.azure-api.net/eldailycompass/Signup', {
                method: 'POST',
    ...
    const handleLogin = async (e) => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch('/https://eldailycompass-apim.azure-api.net/eldailycompass/Login', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
